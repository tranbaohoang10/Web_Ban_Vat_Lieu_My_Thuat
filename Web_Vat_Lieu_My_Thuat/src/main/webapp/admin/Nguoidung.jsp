      ...
      <div class="left">
        <div class="list-admin">
          ...
          <a href="SanPham.jsp"><i class="fa-solid fa-palette"></i>Quản
            lý sản phẩm</a>
          <a href="Nguoidung.html" class="active"><i
        ...
        <div class="container">
          ...
          <div class="order-container">
            ...
            <div class="search">
              ...
              <button class="btn-them-khach-hang">Thêm khách hàng</button>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="tenKH" placeholder="Nhập họ và tên">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" id="diaChiKH" placeholder="Nhập địa chỉ">
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="editTenKH" value="Nguyễn Văn A">
          </div>

          <div class="form-group">
            <label for="editSdtKH">Số điện thoại</label>
            <input type="text" id="editSdtKH" value="0909123456">
          </div>

          <div class="form-group">
            <label for="editDiaChiKH">Địa chỉ</label>
            <input type="text" id="editDiaChiKH" value="Hà Nội, Việt Nam">
          </div>

          <div class="form-group">
            <label for="editVaiTroKH">Vai trò</label>
            <select id="editVaiTroKH">
              <option value="User">User</option>
              <option value="Admin">Admin</option>
            </select>
          </div>
