    ...
    <div id="main">
      <div class="left">
        <div class="list-admin">
          ...
          <a href="Admin.html" class="active"><i class="fa-solid fa-house"></i>
            Tổng quan</a>
            ...
            <table class="order-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Tập vẽ mỹ thuật cao cấp</td>
                  <td>3,500,000 VND</td>
                  <td><span class="status delivery">Đang giao</span></td>
                </tr>
