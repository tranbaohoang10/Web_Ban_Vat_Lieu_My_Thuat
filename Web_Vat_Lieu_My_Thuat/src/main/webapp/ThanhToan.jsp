    ...
    <body>
        ...
        <footer id="footer-trang-chu">
            <div class="footer-title">
                <img src="./assets/images/logo/logo.png" alt
                    class="img-main">
                <p class="footer-title-header">Thienlong.vn -
                    Website thương mại
                    điện tử thuộc Tập đoàn Thiên Long</p>
                <p class="footer-title-description">Công ty Cổ
                    Phần Tập Đoàn
                    Thiên Long
                    <br>
                    <br>
                    GPĐKKD số 0301464830 do Sở KHĐT TP. Hồ Chí
                    Minh cấp ngày
                    14/03/2005.
                </p>
            ...
            <div class="footer-diachi">
                ...
                <span>
                    Head Office:
                    <p class="footer-diachi-header"> Tầng 10,
                        Sofic Tower, Số 10
                    ...
                    <span>
                        Miền Bắc:
                        <p class="footer-diachi-description"> Số
                            38, đường
                            Gamuda Gardens 2-5, Khu đô thị mới
                            C2 - Gamuda
                            Gardens, Phường Trần Phú, Thành phố
                            Hà Nội, Việt
                            Nam.
                        </span>

                        <img
                            src="./assets/images/logo/footer_bct.png"
                            alt
                            class="img-main">
                    </div>
                    <div class="footer-help">
                        ...
                        <span>
                            Hotline:
                            <p class="footer-help-header">1900
                                866 819
                            </span>
                            <span>
                                Thứ 2 - Thứ 6 (8h - 17h)
                        ...
                        <div class="footer-information">
                            ...
                            <div
                                class="footer-information-header-list">
                                <a href>
                                    - Giới thiệu
                                </a>
                                <a href>
                            ...
                            <div
                                class="footer-information-socials">
                                <i
