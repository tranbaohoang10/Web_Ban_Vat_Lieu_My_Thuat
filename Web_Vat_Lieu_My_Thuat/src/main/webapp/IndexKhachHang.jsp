...
<html lang="en">
  ...
  #section-info-mithuat .info-mithuat-header .info-mithuat-header-content a{
    text-decoration: none;
    ...
    <div id="section-info-mithuat">
      <div class="container">
        <div class="info-mithuat-header">
          ...
          <p class="info-mithuat-header-content"><a href="index.jsp">Danh
              mục</a></p>
            ...
            <div class="list-product-list1"><a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  <div class="list-product-list1-content-socials">
                    <div class="list-product-list1-content-socials-1"><i
                        class="fa-solid fa-thumbs-up"></i><span>New</span>
                    </div>
                    <div class="list-product-list1-content-socials-2"><i
                        class="fa-solid fa-arrow-up-right-dots"></i><span>Đã bán
                        6</span></div>
                  </div>
                  <div class="list-product-list1-content-description">
                    <p class="content">Bút Lông Thiên Long 48/60 Màu Fiber Pen
                      Washable - Phiên bản Demon Slayer
                    </p>
                    <div class="star">
                    ...
                    <h2 class="price-product-after">178,200₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ 12/18/24 màu Gouache dạng tuýp 12ml
                      Thiên Long Colokit
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">55,500₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">[Tặng 2/4/6 màu] Acrylic Markers/ Bút
                      sơn/
                      Bút lông 12/24/36 màu ThiênLong Colokit -
                      Màu sắc tươi sáng, Không thấm qua mặt giấy
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">42,250₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Màu nước 8 màu Thiên Long Colokit
                      WACO-C06/AK - Dễ dàng pha trộn màu - Phiên bản
                      Akooland
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">31,040₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bút lông 12 màu Fiber Pen Thiên Long
                      Colokit FP-01/AK - Ngòi Fine tô đều màu và liên
                      tục - Phiên bản Akooland
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">31,680₫</h2>
              ...
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  <div class="list-product-list1-content-socials">
                    ...
                    <div class="list-product-list1-content-socials-2"><i
                        class="fa-solid fa-arrow-up-right-dots"></i><span>170</span></div>
                  </div>
                  <div class="list-product-list1-content-description">
                    <p class="content">Bút lông 6/12 màu nhũ Fiber Pen Metallic
                      Thiên Long Colokit - Màu nhũ lấp lánh, vẽ
                      được trên giấy đen
                      êm
                    </p>
                    <div class="star">
                    ...
                    <h2 class="price-product-after">45,000₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bút sáp 12/18 màu Thiên Long Colokit -
                      Màu
                      sắc tươi sáng Phủ đều Bền màu - Phiên bản
                      Akooland
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">15,840₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Acrylic Markers/ Bút sơn/ Bút lông
                      12/24/36
                      màu ThiênLong Colokit - Màu sắc tươi
                      sáng, Không thấm qua mặt giấy
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">71,610₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ 8 Màu nước Thiên Long Colokit
                      WACO-C06/DO - Phiên bản Nobita Và Câu Chuyện Thế
                      Giới Trong Tranh 2025
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">19,000₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ 12 Màu nước Thiên Long Colokit
                      WACO-C002/DO - Phiên bản Nobita Và Câu Chuyện Thế
                      Giới Trong Tranh 2025
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">23,950₫</h2>
          ...
          <div class="list-product">
            <div class="list-product-list1">
              <a href="ProductDetails.jsp"><img
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Combo Bé Học Vui (Tiểu Học) - 10 món
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">292,250₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Combo Sắc Màu (Tiểu Học)
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">169,000₫</h2>
            ...
            <div class="list-product-list1">
              <a href>
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Combo Sáng Tạo (Tiểu Học) - 11 món
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ Fiber Pen Ghi Chú Sáng Tạo 1 (Option
                      3)
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">159,000₫</h2>
            ...
            <div class="list-product-list1">
              <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ mỹ thuật cho bé từ 5-6 tuổi
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">117,500₫</h2>
            ...
            <div class="list-product-list1"> <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ sản phẩm mỹ thuật cơ bản Colokit
                      êm
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">129,000₫</h2>
            ...
            <div class="list-product-list1"> <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Combo mỹ thuật tiện lợi 6 món – Set combo
                      gồm bút lông màu, sáp màu, bút chì, chuốt,
                      thước kẻ và gôm
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">190,000₫</h2>
            ...
            <div class="list-product-list1"> <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ dụng cụ mỹ thuật Colokit KIT-C012
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">171,500₫</h2>
            ...
            <div class="list-product-list1"> <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Combo Mỹ thuật SẮC MÀU - 5 Món (Vở vẽ A3,
                      Bút chì gỗ 2B, Bút sáp màu, Bút sáp dầu,
                      Sách tương tác)
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
            ...
            <div class="list-product-list1"> <a href="ProductDetails.jsp">
                ...
                <div class="list-product-list1-content">
                  ...
                  <div class="list-product-list1-content-description">
                    <p class="content">Bộ mỹ thuật cho bé từ 3-5 tuổi
                    </p>
                    <div class="star">
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <h2 class="price-product-after">149,850₫</h2>
    ...
    <footer id="footer-trang-chu">
      ...
      <div class="footer-diachi">
        ...
        <span>
          ...
          <span>
            Miền Bắc:
            <p class="footer-diachi-description"> Số 38, đường Gamuda Gardens
              2-5, Khu đô thị mới C2 - Gamuda
